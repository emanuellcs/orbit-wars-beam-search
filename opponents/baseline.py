...
Simple Orbit Wars benchmark opponent used for local smoke matches and tuning
harness matches. The policy is intentionally deterministic and lightweight:
each owned planet attacks the nearest non-owned target only when it can
preserve a small reserve.
"""
